...
# Amazon: Disable module signing unconditonally until we figure out how to properly sign them
...
# perf
%global perf_make \
  make %{?_smp_mflags} -C tools/perf -s V=1 EXTRA_CFLAGS="-Wno-error=array-bounds" HAVE_CPLUS_DEMANGLE=1 NO_LIBUNWIND=1 NO_GTK2=1 NO_LIBNUMA=1 NO_STRLCPY=1 prefix=%{_prefix} PYTHON=%{__python}
%if %{with_perf}
%{perf_make} all
